...
obfusction is a way to make the password hard to be readed in javascript so "going down 3 floors" could be mean <br>
that the password processed 3 times using obfuscation <br>
